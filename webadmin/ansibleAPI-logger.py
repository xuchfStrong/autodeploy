...
ANSIBLE_CFG = WORKHOME + '/ansible.cfg'
print(GROUPVAR)
print(HOSTSINVENTORY)
print(PLAYBOOK)


logger = logging.getLogger(__name__)
logger.setLevel(level = logging.INFO)
handler = logging.FileHandler("/var/log/ansible.log")
...
class ResultCallback(CallbackBase):
    ...
    def v2_runner_on_ok(self, result, *args, **kwargs):
        ...
        logger.warning('===v2_runner_on_ok====host=%s===result=%s' % (host, result._result))
        print("This is test in ansibleAPI")
        # print(json.dumps({host: result._result}, indent=4))
        logger.warning(json.dumps({host: result._result}, indent=4))
